...
{
    public sealed class IntegratedSnapshotTests
    {
        ...
        [Test]
        public void Builder_RejectsNullSession()
        {
        ...
        [Test]
        public void Builder_UsesSessionIdentity()
        {
        ...
        [Test]
        public void Builder_UsesSessionEconomyFields()
        {
            IntegratedGameStateSnapshot source =
                PersistenceTestFactory.ClosedSnapshot(
                    cashCents: 9876);
        ...
        [Test]
        public void Builder_RoundTripsSessionSnapshot()
        {
            IntegratedGameStateSnapshot source =
                PersistenceTestFactory.ClosedSnapshot();
        ...
        [Test]
        public void Builder_ExtractRejectsNull()
        {
            Assert.Throws<System.ArgumentNullException>(
                () => new IntegratedGameStateBuilder()
