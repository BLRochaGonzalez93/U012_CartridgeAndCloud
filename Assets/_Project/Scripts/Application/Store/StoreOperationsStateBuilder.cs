...
namespace VRMGames.CartridgeAndCloud.Application.Store
{
    internal sealed class StoreOperationsStateBuilder
    {
        ...
        public List<StoreStockRecord>
            FurnitureWarehouse { get; }
        public List<StoreStockRecord>
            ProductWarehouse { get; }
        public List<PlacedStoreFixtureRecord>
            Fixtures { get; }
        ...
        public StoreOperationsStateBuilder(
            StoreOperationsState source)
        {
            _source = source ??
        ...
        public StoreOperationsState Build(
