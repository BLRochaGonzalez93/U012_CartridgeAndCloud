...
namespace VRMGames.CartridgeAndCloud.Runtime.Development.Blockout
{
    public static class StoreBlockoutVisualFactory
    {
        ...
        public static GameObject BuildProduct(
            Transform parent,
            RetailProductDefinition definition,
            Material material,
