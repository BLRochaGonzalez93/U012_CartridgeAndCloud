...
subtitle: "Alcance jugable y condiciones técnicas de entrada actualizadas"
...
# 0. Condiciones de entrada tras Sprint 0

La fundación técnica necesaria para comenzar el desarrollo del vertical slice está disponible:

- proyecto Unity y URP reproducibles;
- capas y assemblies definidos;
- escenas Bootstrap, MainMenu, Store y TestLab;
- perfil Windows x64;
- suite de regresión 9/9;
- proceso de build, logs, hashes, tags y release técnica;
- documentación y trazabilidad operativas.

Esto no implica que el vertical slice esté implementado. Movimiento, cámara, construcción, inventario, clientes, caja, economía, tiempo y persistencia continúan pendientes y deberán cumplir los criterios de este documento.
