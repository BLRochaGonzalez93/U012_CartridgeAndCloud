...
subtitle: "Producción, diseño, tecnología, QA y documentación viva tras Sprint 0"
...
# 0. Estado real incorporado en la baseline v0.4

Esta revisión conserva la dirección conceptual aprobada y añade la evidencia técnica alcanzada durante Sprint 0.

| Área | Estado validado al cierre |
|---|---|
| Repositorio | `BLRochaGonzalez93/U012_CartridgeAndCloud`, rama `main` |
| Motor | Unity 6.3 LTS `6000.3.18f1` |
| Render | URP `17.3.0`, color space Linear |
| Identidad | `VRM Games`, `Cartridge & Cloud`, versión `0.0.1` |
| Application Identifier | `com.vrmgames.cartridgeandcloud` |
| Arquitectura | Domain, Application, Infrastructure y Presentation; dos assemblies de test |
| Escenas | Bootstrap, MainMenu, Store y TestLab |
| QA automatizada | 5 EditMode + 4 PlayMode, 9/9 PASS antes y después de Build002 |
| Build final | Windows x64 Development, Mono, LZ4, ejecución externa PASS |
| Hito | Tag y release `v0.0.1-project-foundation` creados |

La base técnica está congelada. La siguiente fase puede implementar sistemas jugables sin reabrir las decisiones de fundación salvo ADR explícita.
...
| Código | Base técnica creada; gameplay no iniciado |
| Proyecto Unity | Creado y validado en Unity 6.3 LTS `6000.3.18f1` |
| Vertical slice | Especificado; condiciones técnicas de entrada satisfechas |
| Sprints | Sprint 0 cerrado y etiquetado como `v0.0.1-project-foundation` |
| Identidad visual | Dirección aprobada; producción de assets pendiente |
| Steam | Release técnica en GitHub creada; Steamworks no iniciado |
