...
subtitle: "Diseño completo del producto para PC/Steam"
...
# 1. Objetivo y alcance del GDD

Este documento transforma las decisiones de `Enfoque_v0.6.md` en reglas oficiales de producto. Los valores marcados como provisionales se validarán mediante prototipos y telemetría interna; las fases avanzadas no forman parte del primer vertical slice.

# 2. Visión, mundo y experiencia
...
# 3. Sistemas de tienda y clientes
...
# 5. Líneas empresariales avanzadas
...
# 6. Progresión, pilares y diferenciación
...
# 8. Alcance de lanzamiento previsto

La versión comercial debe ofrecer la progresión completa hasta la plataforma digital y su condición de victoria. El contenido exacto, número de productos, eventos, competidores, juegos y regiones se ajustará durante Alpha. No se comprometen por adelantado integraciones de Steam adicionales más allá de la distribución base.

# 9. Métricas de diseño
...
# 10. Criterios de revisión del GDD

El GDD se revisará tras el vertical slice, MVP, Alpha y Beta. Ningún cambio de visión se aplicará solo en código: primero se actualizan GDD, modelo de datos, QA y trazabilidad.
