...
subtitle: "Estrategia QA y baseline automática validada"
...
# 0. Baseline automática de Sprint 0

## EditMode - 5 tests

1. Grafo de dependencias de assemblies de producción.
2. Referencias, plataformas y restricciones de assemblies de test.
3. Existencia de las cuatro escenas aprobadas.
4. Scene List con contenido y orden aprobados.
5. Build indexes 0-3 coherentes.

## PlayMode - 4 tests

1. Bootstrap carga sin GameObjects raíz.
2. MainMenu carga con cámara y luz baseline.
3. Store carga con cámara y luz baseline.
4. TestLab carga con cámara y luz baseline.

## Resultado de cierre

- 9/9 PASS antes de Build002.
- 9/9 PASS después de Build002.
- Build Windows ejecutado fuera del Editor.
- Player.log sin crashes ni excepciones no controladas.

Toda modificación de paquetes, asmdefs, escenas, Scene List o perfil de build debe ejecutar esta suite completa como regresión mínima.


# 1. Objetivo

Integrar QA desde la fundación y ampliar la suite conforme entren sistemas de gameplay. Sprint 0 deja una baseline automática estructural ya validada.
