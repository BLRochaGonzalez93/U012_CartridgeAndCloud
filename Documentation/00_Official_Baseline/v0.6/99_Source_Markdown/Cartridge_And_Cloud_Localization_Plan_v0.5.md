---
title: "Cartridge & Cloud - Localization Plan v0.5"
...
Español como idioma de desarrollo. Inglés como primer idioma de publicación objetivo.

# 2. Reglas

Strings mediante keys, sin texto concatenado, números/moneda localizables, UI flexible, placeholders documentados y fuentes con cobertura.

# 3. Estado

Localization package está instalado. La localización completa y QA lingüística pertenecen a fases posteriores al vertical slice, salvo textos necesarios para la build interna.
