---
title: "Cartridge & Cloud - Documentation Validation Report v0.4"
...
Validación estructural, semántica y de continuidad de baseline v0.6.

# 2. Controles previstos

- estructura de carpetas;
- presencia de documentos obligatorios;
- coherencia de versión y fecha;
- diferenciación entre estado cerrado y working copy;
- consistencia de sprints y test counts;
- apertura de XLSX;
- render de PDFs;
...
El resultado final se refleja también en `DOCUMENTATION_VALIDATION_REPORT.md` y `BASELINE_INTEGRITY_REPORT.md` tras completar el empaquetado.
