---
title: "Cartridge & Cloud - Steam Publishing Plan v0.5"
...
App setup, store page, build depots, playtest/demo, localization, achievements/cloud si se aprueban, review y lanzamiento.

# 2. Requisitos previos

Vertical slice aprobado, identidad visual estable, licencias cerradas, save paths, opciones, crash-free build y materiales de tienda.

# 3. Estado

Planned / Deferred. No forma parte de S16-S17 salvo compatibilidad de plataforma Windows y estructura de builds.
