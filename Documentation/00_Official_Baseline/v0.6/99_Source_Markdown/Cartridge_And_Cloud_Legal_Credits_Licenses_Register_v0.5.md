---
title: "Cartridge & Cloud - Legal, Credits & Licenses Register v0.5"
...
Todo asset, fuente, audio, plugin o código externo debe registrar origen, licencia, autor, fecha, restricciones y ubicación.

# 2. Estado

Unity y paquetes oficiales se rigen por sus licencias. Los assets representativos internos del kit Blender se consideran producción propia hasta que se documente lo contrario. No usar marcas o carátulas reales.

# 3. Gate

Antes de Steam, revisar THIRD_PARTY_NOTICES, créditos, licencias de audio/fuentes, privacidad y uso de marcas.
