---
title: "Cartridge & Cloud - Marketing Plan v0.5"
...
Simulador de gestión de tienda de videojuegos con logística visible, construcción funcional y progresión desde negocio local.

# 2. Materiales futuros

Key art, cápsulas Steam, trailer, GIFs de bucle diario, screenshots de StoreInitial, devlogs y press kit.

# 3. Gate de comunicación

No presentar públicamente el vertical slice hasta que StoreInitial, UI, arte, audio y build hayan superado S17.
