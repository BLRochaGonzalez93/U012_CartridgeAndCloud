---
title: "Cartridge & Cloud - Package Manifest v0.3"
...
El manifiesto machine-readable definitivo se encuentra en `BASELINE_MANIFEST.csv` y `CHECKSUMS_SHA256.txt`.
...
- QA/producción;
- negocio/release;
- desarrollo y handoff;
- fuentes Markdown.

# Exclusiones

No incluye código, escenas, assets Unity, builds, caches, credenciales, datos personales sensibles ni binarios de herramientas.
