---
title: "Cartridge & Cloud - Enfoque del Proyecto"
subtitle: "Fuente conceptual consolidada de las 26 decisiones"
...
**Documento de trabajo conceptual — Versión 0.6**  
**Proyecto provisional oficial:** Cartridge & Cloud  
**Nombre anterior del proyecto:** Indie Studio Simulator  
**Estado:** Dirección conceptual completa y decisiones 1–26 aprobadas

***

# Convenciones de edición

Este documento se mantiene como archivo de trabajo para introducir observaciones directamente y devolverlo después para su consolidación.

## Estilo del asistente

El contenido base utiliza Markdown normal:

- Títulos con `#`, `##` y `###`.
- Texto normal para explicaciones.
- Negrita para conceptos importantes.
- Listas con guiones.
- Bloques de código para flujos, fórmulas y estructuras.
- Tablas para comparaciones y datos.

## Estilo del usuario

Para distinguir claramente tus modificaciones, utiliza bloques de cita con una etiqueta visible:

```md
> **🟨 ANOTACIÓN DEL USUARIO:** Comentario, corrección o ampliación.
> **🟧 SUSTITUIR POR:** Texto que debe reemplazar al actual.
> **🟥 ELIMINAR:** Contenido que debe eliminarse.
> **🟩 APROBADO:** Sección validada sin cambios.
> **🟦 DUDA:** Cuestión pendiente de resolver.
> **🟪 IDEA PENDIENTE:** Propuesta para estudiar posteriormente.
```

Coloca siempre la anotación inmediatamente debajo del contenido al que se refiere.

## Estados de los apartados

Al final de cada apartado aparece uno de estos estados:

- **COMPLETO:** La dirección conceptual está suficientemente definida.
- **PARCIALMENTE DEFINIDO:** La base está aprobada, pero faltan decisiones concretas.
- **PENDIENTE:** El sistema todavía necesita una definición sustancial.
- **APLAZADO:** La dirección general está registrada, pero su diseño detallado se realizará en una etapa posterior.

***

# 1. Estado actual de la dirección

El desarrollo técnico de **Indie Studio Simulator** queda temporalmente pausado después del Sprint 6.1.

La pausa no se debe a un problema técnico, sino a una revisión de identidad del producto. La visión original compartía demasiados elementos estructurales con juegos como:

- Game Dev Tycoon.
- Games Tycoon.
- Game Builder Tycoon.
- Otros simuladores de estudios de videojuegos.

El nuevo proyecto debe evitar depender del modelo clásico:

```text
Elegir tema y género
...
→ contratar
→ ampliar oficina
→ crear juegos más grandes
```

El objetivo actualizado es transformar el proyecto en una experiencia con:
...
- Estilo visual low poly con texturas handpainted/cartoon y shaders de bordes sombreados tipo tinta.
...
- Clientes representados como NPCs con máquina de estados.
- Productos físicos, estanterías, vitrinas, almacén y mobiliario.
...
# 32. Cierre de decisiones conceptuales 1–26

Las decisiones conceptuales enumeradas en este documento han quedado aprobadas.

## Bloques cerrados

1. Identidad, tono, público, duración y final.
2. Economía inicial, costes, impuestos, márgenes y dificultad.
3. Empleados, contratación, progresión, cansancio, salarios, despidos y automatización.
4. Eventos y ritmo empresarial.
5. Vertical slice.
6. Publishing.
7. Desarrollo interno.
8. Comercio online.
9. Plataforma digital.
10. Infraestructura y servicios online.
11. Mercado y competidores.

No quedan decisiones estructurales abiertas que bloqueen la actualización de los documentos principales, la auditoría del código o el diseño de la nueva arquitectura.

Permanecerán como trabajo posterior:

- Balance numérico.
- Contenido configurable.
- Producción de árboles, catálogos, productos, eventos y competidores concretos.
- Diseño técnico detallado.
- Validación mediante prototipos y pruebas.
- Revisión de decisiones si la implementación demuestra un problema estructural.

> **Estado del apartado: COMPLETO.**  
> Las `26` decisiones conceptuales están cerradas. El documento entra en fase de traducción a documentación de producción y arquitectura técnica.
...
# 35. Resumen de estado del documento

| Área | Estado |
|---|---|
| Nombre provisional oficial | Cartridge & Cloud |
| Visión principal | Completa |
| Fantasía del jugador | Completa |
| Diferenciación | Completa |
| Tono narrativo | Completo |
| Público objetivo | Completo |
| Duración objetivo | Completa conceptualmente |
| Condición de victoria y postgame | Completa conceptualmente |
| Pilares y anti-pilares | Completos |
| Mapa y escala | Completos conceptualmente |
| Modelo de expansión física | Completo conceptualmente |
| Estilo visual | Parcialmente definido |
| Cámara | Completa conceptualmente |
| Movimiento y navegación | Completos conceptualmente |
| Cuadrícula y colocación | Completas conceptualmente |
| Bucle diario | Completo conceptualmente |
| Economía inicial | Completa conceptualmente |
| Márgenes y dificultad | Completos conceptualmente |
| Tienda física | Completa conceptualmente |
| Productos y stock | Completos conceptualmente |
| Reservas | Completas conceptualmente |
| Clientes | Completos conceptualmente |
| Puestos informáticos | Completos conceptualmente |
| Empleados | Completos conceptualmente |
| Eventos | Completos conceptualmente |
| Investigación | Completa conceptualmente |
| Progresión empresarial | Completa conceptualmente |
| Vertical slice | Aprobado conceptualmente |
| Publishing | Completo conceptualmente |
| Desarrollo interno | Completo conceptualmente |
| Comercio online detallado | Completo conceptualmente |
| Plataforma digital detallada | Completa conceptualmente |
| Infraestructura y servicios online | Completos conceptualmente |
| Competidores y mercado | Completos conceptualmente |
| Auditoría del código | Pendiente |
| Arquitectura nueva | Pendiente de auditoría |
| Roadmap por sprints | Pendiente de auditoría |
| Decisiones conceptuales 1–26 | 26 aprobadas |
| Decisiones conceptuales abiertas | 0 |

> **Estado del apartado: COMPLETO COMO RESUMEN DE CONTROL.**  
> Refleja el estado consolidado de la versión 0.6. Las decisiones 1–26 están cerradas; el siguiente trabajo es documental, técnico y de validación.

***

# Anexo A. Registro de decisiones consolidadas 1–26

Este anexo funciona como índice de trazabilidad conceptual. Los detalles se encuentran integrados en los apartados correspondientes.

| Nº | Decisión aprobada | Resultado consolidado |
|---:|---|---|
| 1 | Nombre | Cinco finalistas; **Cartridge & Cloud** como nombre provisional oficial |
| 2 | Tono | Profesional y cercano, humor ligero y nostalgia inicial |
| 3 | Público | Jugadores de simuladores, tiendas y tycoon |
| 4 | Duración | 35–60 horas hasta late game; sesiones de 30–90 minutos |
| 5 | Final | Victoria principal, continuación libre e hitos secundarios |
| 6 | Capital inicial | 20.000 € en dificultad Estándar |
| 7 | Costes fijos | Alquiler diario + construcción y mantenimiento por ampliación |
| 8 | Impuestos | 10 % semanal sobre beneficio positivo y gastos transparentes |
| 9 | Márgenes | Margen bruto medio objetivo del 35 %, diferenciado por familia |
| 10 | Dificultad | Relajada, Estándar, Exigente y Sandbox personalizable |
| 11 | Contratación | Perfiles, categorías, canales y candidatos transparentes |
| 12 | Progresión | Nivel 1–10, habilidades 1–5, XP específica y especializaciones |
| 13 | Descansos | Cansancio 0–100, descansos automáticos y zonas de recuperación |
| 14 | Salarios | Revisiones por hitos, contraofertas, aplazamientos y estados contractuales |
| 15 | Despidos | Prueba, planificado e inmediato; reputación laboral 0–100 |
| 16 | Cierre de empleados | Protocolo 21:45–22:15 y políticas seguras por tarea |
| 17 | Automatización | Puntuación por prioridad, perfil, habilidad, urgencia, distancia y cansancio |
| 18 | Eventos | Dinámicos, programados e hitos con frecuencia y protecciones aprobadas |
| 19 | Etapas 3–6 | Requisitos, inversiones, hitos y ritmo de 12–60 horas |
| 20 | Vertical slice | Tienda física de siete días con criterios de aceptación y DoD |
| 21 | Publishing | Propuestas, due diligence, contratos, hitos, reputación editorial y liquidaciones |
| 22 | Desarrollo interno | Insights, brief, pilares, prototipos, greenlight, backlog, builds, playtests y lanzamiento |
| 23 | Comercio online | Stock multicanal, picking, packing, transportistas, reputación, devoluciones y analítica |
| 24 | Plataforma digital | Cuentas, bibliotecas, licencias, catálogo, comisiones, descubrimiento, victoria y postgame |
| 25 | Infraestructura | Pools de capacidad, módulos, escalado, prioridades, redundancia, incidencias y servicios |
| 26 | Competidores | Mercado híbrido, arquetipos, cuotas, reacciones, talento, estudios, noticias y ciclos |

***

# Anexo B. Historial de versión

## Versión 0.6

- Integrados y cerrados los etapas avanzadas 21–26.
- Definido el publishing con propuestas, contratos, hitos, reputación y liquidaciones.
- Sustituido el antiguo bucle de desarrollo interno por visión, prototipado, greenlight, backlog, builds y playtests.
- Separados formalmente comercio online físico y plataforma digital.
- Definida la plataforma, su modelo comercial, sus usuarios, su catálogo y la condición principal de victoria.
- Fijada una profundidad estratégica intermedia para infraestructura y servicios online.
- Añadido el modelo híbrido de competidores y simulación de mercado.
- Cerrado el apartado de decisiones conceptuales pendientes: `26/26` aprobadas.
- Actualizados dirección, estados, trazabilidad y secuencia de preproducción.

## Versión 0.5

- Adoptado **Cartridge & Cloud** como nombre provisional oficial.
- Integradas y cerradas las decisiones 1–26.
- Añadidos público, duración, tono, victoria y postgame.
- Consolidada la economía inicial, costes, impuestos, márgenes y dificultades.
- Completado conceptualmente el sistema de empleados.
- Añadido el sistema de eventos.
- Sustituida la progresión empresarial provisional por requisitos consolidados.
- Aprobado formalmente el primer vertical slice.
- Reducido el apartado 31 de 26 a 6 decisiones avanzadas abiertas.
- Actualizados los estados de control y la secuencia posterior.
