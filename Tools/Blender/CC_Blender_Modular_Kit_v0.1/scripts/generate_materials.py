"""Create the shared Blender material reference library.
These are preview materials, not final Unity URP shaders or texture sets.
"""
...
def generate():
    ...
    print(f"Cartridge & Cloud: {len(mats)} shared preview materials ready.")
